//
//  CaseDocumentsViewController2.h
//  GuiZhouRMMobile
//
...
@interface CaseDocumentsViewController2 : UIViewController<UIPrintInteractionControllerDelegate,UINavigationControllerDelegate,UIWebViewDelegate,UITextFieldDelegate,UITextViewDelegate,CaseDocumentsDelegate> {
    CGPoint svos;
}
