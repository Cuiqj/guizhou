...
@interface NewInspectionViewController : UIViewController<InspectionPickerDelegate,DatetimePickerHandler,UITextFieldDelegate>
...
@property (weak, nonatomic) IBOutlet UITextView *viewPath;
@property (weak, nonatomic) IBOutlet UITextView *viewInspectorName;
